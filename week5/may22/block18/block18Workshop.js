...
function concatOdds(arr1, arr2) {
  ...
  // Loop through arr1 and push odd integers to the new array
    arr1.forEach(function (num){
        if (num % 2 === 1 && !onlyOdd.includes(num)){
            onlyOdd.push(num)
        }
    });
     // Loop through arr2 and push odd integers to the new array
  arr2.forEach(function (num) {
    if (num % 2 !== 0 && !onlyOdd.includes(num)) {
      onlyOdd.push(num);
    }
  });
